...
//     while (i >= 'a') finquando la lettera non arriva alla a
//     {
...
// ft_print_interval -> funzione che stampa dei caratteri decisi dai parametri che segnano l'inizio e la fine
// void ft_print_interval(char start, char end) funzione con parametri
// {
//     while(start <= end) finquando non si arriva al carattere di fine, passato come parametro
//     {
//         ft_putchar(start); stampiamo le lettere
//         start++; e le incrementiamo
//     }
//     write(1, "\n", 1); stampiamo la new line una volta finito
// }
...
//     }
//     int i = 0; inizializiamo l'indice a 0
//     char tmp = argv[1][i]; e si dichiara una temporanea
...
//                 tmp = 'a'; il carattere dopo deve essere una 'a'
//             else altrimenti
//                 tmp += 1; gli assegna la lettera alfabetica dopo
//         }
...
//                 tmp = 'A'; perchè in questo caso il carattere successivo deve essere la 'A'
//             else altrimenti
//                 tmp += 1; gli assegna il carattere successivo
//         }
//         write(1, &tmp, 1); stampa la temporanea
...
// {
// 	if (n == 0) se appena si passa è zero
// 		return 0; si termina il programma
...
// epur_str -> programma che prende una stringa e la visuailizza con esattamente uno spazio
// int main(int argc, char *argv[])
// {
...
// 	if (argv[1][i] == 32 || (argv[1][i] >= 9 && argv[1][i] <= 13)) se si trovano spazi o caratteri speciali
// 	{
// 		i++; si incrementa
// 	}
...
// void ft_putnbr(int n) //si passa coem parametro un int
// {
